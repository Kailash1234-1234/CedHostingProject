        ...
        <div class="container">
            ...
            <div class="blog-grids">
                <div class="col-md-1 blog-grid">
                    ...
                    <h6><span class="glyphicon glyphicon-thumbs-up" 
                    aria-hidden="true"></span> 15</h6>
                    <h6><span class="glyphicon glyphicon-comment"
                     aria-hidden="true"></span> 10</h6>
                </div>
                <div class="col-md-11 blog-grid1">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. 
                        ...
                        magna. Donec accumsan malesuada orci. Donec sit amet 
                        eros. Lorem ipsum dolor sit amet, consectetuer 
                        adipiscing elit. </p>
            ...
            <div class="blog-grids">
                <div class="col-md-1 blog-grid">
                    ...
                    <h6><span class="glyphicon glyphicon-thumbs-up" 
                    aria-hidden="true"></span> 20</h6>
                    <h6><span class="glyphicon glyphicon-comment"
                     aria-hidden="true"></span> 12</h6>
                </div>
                <div class="col-md-11 blog-grid1">
                    <a href="single.php" class="mask"><img src="images/b2.jpg" 
                    class="img-responsive zoom-img" alt=""/></a>
                    <h4>Praesent justo dolor, lobortis quis, lobortis dignissim</h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                        Praesent vestibulum molestie lacus. Aenean nonummy hendrerit
                        ...
                        luctus a, lorem. Maecenas tristique orci ac sem. Duis 
                        ultricies pharetra magna. Donec accumsan malesuada orci. 
                        Donec sit amet eros. Lorem ipsum dolor sit amet, 
            ...
            <div class="blog-grids">
                <div class="col-md-1 blog-grid">
                    ...
                    <h6><span class="glyphicon glyphicon-thumbs-up"
                     aria-hidden="true"></span> 25</h6>
                    <h6><span class="glyphicon glyphicon-comment"
                     aria-hidden="true"></span> 15</h6>
                </div>
                <div class="col-md-11 blog-grid1">
                    <a href="single.php" class="mask"><img src="images/b3.jpg" 
                    class="img-responsive zoom-img" alt=""/></a>
                    <h4>Praesent justo dolor, lobortis quis, lobortis dignissim</h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                        Praesent vestibulum molestie lacus. Aenean nonummy 
                        hendrerit mauris. Phasellus porta. Fusce suscipit
                        ...
                        Duis ultricies pharetra magna. Donec accumsan 
